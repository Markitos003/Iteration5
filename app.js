...
app.post('/', async (req, res) => {
  ...
  try {
    ...
    if (songsCount === 0 && djsCount === 0) {
      await Promise.all([
        Song.insertMany([{ title: 'Sunset Serenade', artist: 'Melody Maker', duration: 180, genre: 'Pop' },
        { title: 'Moonlit Lullaby', artist: 'Harmony Harmony', duration: 210, genre: 'Acoustic' },
        { title: 'Electric Pulse', artist: 'Synth Wizard', duration: 150, genre: 'Electronic' },
        { title: 'Jazzed Up', artist: 'Smooth Sax', duration: 240, genre: 'Jazz' },
        { title: 'Rock Revolution', artist: 'Guitar Guru', duration: 200, genre: 'Rock' },
        { title: 'Funky Groove', artist: 'Bass Master', duration: 180, genre: 'Funk' },
        { title: 'Country Roads', artist: 'Twangy Twister', duration: 190, genre: 'Country' },
        { title: 'Reggae Rhythm', artist: 'Island Vibes', duration: 170, genre: 'Reggae' },
        { title: 'Classical Sonata', artist: 'Orchestra Maestro', duration: 300, genre: 'Classical' },
        { title: 'Hip Hop Hustle', artist: 'Rap Ruler', duration: 220, genre: 'Hip Hop' },
        { title: 'Metal Mayhem', artist: 'Shredder Supreme', duration: 180, genre: 'Metal' },
        { title: 'Bluesy Bliss', artist: 'Soulful Singer', duration: 160, genre: 'Blues' },
        { title: 'Piano Prelude', artist: 'Keynote Pianist', duration: 130, genre: 'Piano' },
        { title: 'Dance Floor Dream', artist: 'EDM Enchanter', duration: 190, genre: 'Dance' },
        { title: 'Gospel Glory', artist: 'Divine Voices', duration: 210, genre: 'Gospel' },
        { title: 'Ambient Aura', artist: 'Soundscapes Creator', duration: 250, genre: 'Ambient' },
        { title: 'Salsa Celebration', artist: 'Rhythmic Reveler', duration: 200, genre: 'Salsa' },
        { title: 'Indie Innovation', artist: 'Alternative Artisan', duration: 170, genre: 'Indie' },
        { title: 'Synthwave Symphony', artist: 'Vaporwave Voyager', duration: 230, genre: 'Synthwave' },
        { title: 'World Beat', artist: 'Global Grooves', duration: 180, genre: 'World' },
        { title: 'Disco Delight', artist: 'Boogie Bee', duration: 200, genre: 'Disco' },
        { title: 'R&B Romance', artist: 'Soul Serenader', duration: 210, genre: 'R&B' },
        { title: 'Bluegrass Breeze', artist: 'Banjo Ballad', duration: 160, genre: 'Bluegrass' },
        { title: 'Techno Trance', artist: 'Beat Bouncer', duration: 220, genre: 'Techno' },
        { title: 'Chillhop Chill', artist: 'Laid-back Lyricist', duration: 190, genre: 'Chillhop' }]),
...
app.get('/index3', async (req, res) => {
  try {

    const playlist = await Playlist.find();

    res.render('index3', { playlist });
  } catch (error) {
